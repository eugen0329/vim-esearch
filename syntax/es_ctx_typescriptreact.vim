...
syntax match   es_typescriptAliasDeclaration   / [^=]\+/ contained
syn    match   es_typescriptFuncName           / \zs\K\k*\ze\s*(/ nextgroup=es_typescriptCall skipwhite
syntax region  es_typescriptCall               start=/(/hs=e+1 end=/)/he=s-1 end=/^/ contained
syntax match   es_typescriptTypeReference      /\K\k*\(\.\K\k*\)*/ contained
...
syntax match   es_typescriptLineComment        "//.*"
syntax region  es_typescriptComment            start="/\*" end="\*/" end="^"
...
" Shared part across react syntaxes
" copypaste start
...
let b:current_syntax = 'es_ctx_typescriptreact'
