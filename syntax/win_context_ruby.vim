...
syn keyword rubyDefine         alias def undef  nextgroup=rubyFunction skipwhite
syn keyword rubyDefine         class module nextgroup=rubyConstant skipwhite
syn match   rubyFunction       "[a-b]*" contained
syn match   rubyConstant       "\<\u\w*"
syn keyword rubyKeyword        super yield include extend prepend
