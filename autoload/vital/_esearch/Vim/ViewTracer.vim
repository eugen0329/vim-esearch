...
execute join(['function! vital#_esearch#Vim#ViewTracer#import() abort', printf("return map({'jump': '', 'winnr': '', 'exists': '', 'find': '', 'trace_tabpage': '', 'tabnr': '', 'trace_window': ''}, \"vital#_esearch#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
