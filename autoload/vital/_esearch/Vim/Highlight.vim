...
execute join(['function! vital#_esearch#Vim#Highlight#import() abort', printf("return map({'set': '', '_vital_healthcheck': '', 'get': ''}, \"vital#_esearch#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
