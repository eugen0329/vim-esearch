  ...
  describe 'inline' do
    context 'restoring line numbers' do
      context 'when only virtual ui is affected' do
        it 'recovers virtual ui after deleting 1 char' do
        ...
        it 'recovers virtual ui after motion left' do
          1.upto(line_number_text.length) do |column|
            entry.locate!
            editor.locate_column! column
        ...
        it 'recovers virtual ui after motion right' do
      ...
      context 'when virtual ui and result text is affected' do
