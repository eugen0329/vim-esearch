...
module TaggedLogging
  ...
  def log_debug
    class_name_tagged { Configuration.log.debug { yield.inspect } }
  end

  def log_info
    class_name_tagged { Configuration.log.info { yield.inspect } }
  end

  def log_warning
    class_name_tagged { Configuration.log.warn { yield.inspect } }
  end
end
